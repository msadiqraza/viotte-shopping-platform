      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div className="md:col-span-2 lg:col-span-2 flex flex-col gap-2">
            <NewsletterSignup />{" "}
            {/* This component is defined in the Landing Page Components canvas */}
            <h5 className="text-md font-semibold text-white mb-2">
              Contact Us:{" "}
              <a
                href="mailto:contact@viotte.site"
                className="hover:text-orange-400 font-normal transition-colors"
              >
                contact@viotte.site
              </a>
            </h5>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="/blog"
                  onClick={(e) => handleFooterLink(e, "blog")}
                  className="hover:text-orange-400 transition-colors"
                >
                  Blog
                </a>
              ...
              <li>
                <a
                  href="/career"
                  onClick={(e) => handleFooterLink(e, "career")}
                  className="hover:text-orange-400 transition-colors"
                >
                  Career
                </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="/policies"
                  onClick={(e) => handleFooterLink(e, "policies")}
                  className="hover:text-orange-400 transition-colors"
                >
                  Policies
                </a>
              ...
              <li>
                <a
                  href="/terms"
                  onClick={(e) => handleFooterLink(e, "terms")}
                  className="hover:text-orange-400 transition-colors"
                >
                  Terms of Service
                </a>
              ...
              <li>
                <a
                  href="/privacy"
                  onClick={(e) => handleFooterLink(e, "privacy")}
                  className="hover:text-orange-400 transition-colors"
                >
                  Privacy
                </a>
