    ...
    <div className="bg-stone-50">
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-8">
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="space-y-6">
            <div className="bg-orange-100 p-6 rounded-lg shadow text-center h-[190px] flex flex-col justify-center items-center">
              ...
              <button className="bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium py-2 px-4 rounded-md transition-colors">Check-in Now</button>
            </div>
            <div className="bg-orange-100 p-6 rounded-lg shadow text-center h-[190px] flex flex-col justify-center items-center">
        ...
        {loadingStates.featured ? (
          ...
          <ProductCarousel title="Featured Products" products={featuredProducts} onNavigate={onNavigate} />
        )}
